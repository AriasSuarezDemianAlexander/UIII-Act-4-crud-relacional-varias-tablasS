		...
		<tbody>
			...
			?>
				<tr>
					...
					<td><?php echo $producto->descr ?></td>
					<td><?php echo $producto->preciou ?></td>
					<td><?php echo $producto->stockd?></td>
					<td><?php echo $producto->unidadm ?></td>
					<td><?php echo $producto->fechai ?></td>
